        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPermissions_UserModules_UserModuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleOwnerId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermission", x => new { x.UserRoleId, x.UserPermissionId });
                    table.ForeignKey(
                        name: "FK_RolePermission_AspNetRoles_UserRoleId",
                        column: x => x.UserRoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RolePermission_UserPermissions_UserPermissionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FeaturedImagePath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MetaDescription = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ContentLineSpacing = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Posts_PostStatus_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PostId = table.Column<int>(type: "int", nullable: false),
                    ParentTableOfContentId = table.Column<int>(type: "int", nullable: true),
                    Content = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TableOfContents_Posts_PostId",
                        column: x => x.PostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TableOfContents_TableOfContents_ParentTableOfContentId",
                        column: x => x.ParentTableOfContentId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_RoleOwnerId",
                table: "AspNetRoles",
                column: "RoleOwnerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePermission_UserPermissionId",
                table: "RolePermission",
                column: "UserPermissionId");

            migrationBuilder.CreateIndex(
                name: "IX_TableOfContents_ParentTableOfContentId",
                table: "TableOfContents",
                column: "ParentTableOfContentId");

            migrationBuilder.CreateIndex(
                name: "IX_TableOfContents_PostId",
                table: "TableOfContents",
                column: "PostId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_UserModuleId",
